...
class PPOBuffer:
    ...
    def get(self):
        ...
        data = dict(obs=self.obs_buf, act=self.act_buf, ret=self.ret_buf, val=self.val_buf,
...
def generate_batch_data(data, batch_size, mini_batch_size):
    obs, act, ret, val, adv, logp = data['obs'], data['act'], data['ret'], data['val'], data['adv'], data['logp']
