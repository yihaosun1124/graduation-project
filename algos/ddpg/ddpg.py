...
def ddpg(env_fn, env_name, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
...
if __name__ == '__main__':
    ...
    ddpg(lambda : gym.make(args.env), args.env, actor_critic=core.MLPActorCritic,
